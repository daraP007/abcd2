    ...
    <div id="customerTableView">
            ...
            <div class="table responsive">
                ...
                if ($data->num_rows > 0) {
                    ...
                    <div class="dressDesc" contenteditable="true" onBlur="updateValue(this,'description','<?php echo $ID; ?>')"><?php echo $description; ?></div>
                    <div contenteditable="true" onBlur="updateValue(this,'key_words','<?php echo $ID; ?>')"><?php echo $key_words; ?></div> 
                    </div>
